...
<div class="banner">
	<div class="container position-relative">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn; font-weight:bold;"><span style="color:#3F84B1;">Welcome to </span> Utkala Trails</h1>
	</div>
</div>
...
<div class="routes">
	<div class="container">
		<div class="col-md-4 routes-left wow fadeInRight animated" data-wow-delay=".5s">
			<div class="rou-left">
			<a href="#"><i class="fa fa-list" style="font-size:50px;"></i></a>
			</div>
